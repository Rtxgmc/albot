...
const vcard = 'BEGIN:VCARD\n' // jangan ganti
            ...
            + 'FN:ZeroBot\n' // ganti aja 
            + 'ORG: RTXGMC;\n' // ganti aja
            + 'TEL;type=CELL;type=VOICE;waid=6285397907992:+6285397\n'  //ganti nomor lu
...
healawal = 50 // biarin
potionawal = 1 // biarin
replitx = '*SUBSCRIBE RTXGMC*' 
ari = '*YT RTXTMC*'
limitawal = 9999999 // terserah mau ganti apa gak 
memberlimit = 1 // terserah mau ganti apa gak 
namabot = 'ZeroBot'
cr = '*「 ZeroBot 」*' //ganti nama bot
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6285397907992@s.whatsapp.net"]   //ganti nomor lu
//================================ Batas ========================
battre = batre
charg = chargi
charging = false
