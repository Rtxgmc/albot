...
let handler = async (m, { conn }) => {
    ...
    if (new Date - user.lastclaim > 86400000) {
        conn.reply(m.chat, `Anda sudah mengklaim dan mendapatkan 10000000000 💵money dan 100000 potion`, m)
        global.DATABASE._data.users[m.sender].money += 10000000000
        global.DATABASE._data.users[m.sender].potion += 100000
